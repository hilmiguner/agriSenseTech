                ...
                <View>
                    ...
                    <Pressable style={{ backgroundColor: "#f1f1f1", marginHorizontal: 32, borderRadius: 24, padding: 12, marginBottom: 12 }} disabled={isAuthenticating} onPress={() => {
                    ...
                    }}>
                        {
                            ...
                            <ActivityIndicator />
                            :
                            <Text style={{ textAlign: "center", color: "black", fontWeight: "bold", fontSize: 20 }}>Login</Text>
                        }
                    </Pressable>
                    <Pressable>
                        <Text style={{ textAlign: "center", textDecorationLine: "underline", color: "white", fontSize: 18 }}>Forgot your password?</Text>
                    </Pressable>
                </View>
                <View>
